...
namespace Server_Strategico.Gioco
{
    internal class Battaglie
    {
        ...
        public static async Task<bool> Battaglia_Distanza(string struttura, Player player, Guid clientGuid)
        {
            ...
            if (player.Frecce < arcieri * Esercito.Unità.Arciere.Componente_Lancio + catapulte * Esercito.Unità.Catapulta.Componente_Lancio)
            {
                Send(clientGuid, $"Log_Server|Gli arceri e le catapulte del giocatore subiscono una riduzione del danno per mancanza di frecce [{arcieri * Esercito.Unità.Arciere.Componente_Lancio + catapulte * Esercito.Unità.Catapulta.Componente_Lancio}/{player.Frecce}]:");
            ...
            if (arcieri > 0 || catapulte > 0)
            {
                ...
                {
                    Send(clientGuid, $"Log_Server|Guerrieri morti: {guerrieri_Morti_Att}/{Giocatori.Barbari.PVP.Guerrieri} Lancieri morti:  {lancieri_Morti_Att}/{Giocatori.Barbari.PVP.Lancieri}\r\n Esperienza: +{esperienza}\r\n");
                    Send(clientGuid, $"Log_Server|Gli arceri e le catapulte del giocatore hanno causato:");
                    Send(clientGuid, $"Log_Server|Frecce utilizzate: {arcieri * Esercito.Unità.Arciere.Componente_Lancio + catapulte * Esercito.Unità.Catapulta.Componente_Lancio}/{player.Frecce}");
                    Giocatori.Barbari.PVP.Guerrieri = guerrieri_Enemy;
                    Giocatori.Barbari.PVP.Lancieri = picchieri_Enemy;
                }
                if (struttura == "Barbari_PVE")
                {
                    Send(clientGuid, $"Log_Server|Guerrieri morti: {guerrieri_Morti_Att}/{player.Guerrieri_Barbari_PVE} Lancieri morti:  {lancieri_Morti_Att}/{player.Lancieri_Barbari_PVE}\r\n Esperienza: +{esperienza}\r\n");
                    Send(clientGuid, $"Log_Server|Gli arceri e le catapulte del giocatore hanno causato:");
                    Send(clientGuid, $"Log_Server|Frecce utilizzate: {arcieri * Esercito.Unità.Arciere.Componente_Lancio + catapulte * Esercito.Unità.Catapulta.Componente_Lancio}/{player.Frecce}");
            ...
            if (arcieri_Enemy > 0 || catapulte_Enemy > 0)
            {
                ...
                Send(clientGuid, $"Log_Server|Guerrieri morti: {guerrieri_Morti}/{player.Guerrieri} Lancieri morti:  {lancieri_Morti}/{player.Lancieri}\r\n");
        ...
        public static async Task<bool> Battaglia_Distanza(Player player, Guid clientGuid, Player player2, Guid clientGuid2)
        {
            ...
            if (player.Frecce < arcieri * Esercito.Unità.Arciere.Componente_Lancio + catapulte * Esercito.Unità.Catapulta.Componente_Lancio)
            {
                Send(clientGuid, $"Log_Server|Gli arceri e le catapulte del giocatore [{player.Username}] subiscono una riduzione del danno per mancanza di frecce [{arcieri * Esercito.Unità.Arciere.Componente_Lancio + catapulte * Esercito.Unità.Catapulta.Componente_Lancio}/{player.Frecce}]:");
                arcieri_Temp = arcieri_Temp / 3;
                catapulte_Temp = catapulte_Temp / 3;
                player.Frecce = 0;
            }
            ...
            {
                Send(clientGuid, $"Log_Server|Gli arceri e le catapulte del giocatore [{player2.Username}] subiscono una riduzione del danno per mancanza di frecce [{arcieri_Enemy * Esercito.Unità.Arciere.Componente_Lancio + catapulte_Enemy * Esercito.Unità.Catapulta.Componente_Lancio}/{player.Frecce}]:");
            ...
            if (arcieri > 0 || catapulte > 0)
            {
                ...
                Send(clientGuid2, $"Log_Server|Guerrieri morti: {guerrieri_Morti}/{player2.Guerrieri} Lancieri morti:  {lancieri_Morti}/{player2.Lancieri}\r\n Esperienza:  {esperienza2}\r\n");
                Send(clientGuid2, $"Log_Server|Gli arceri e le catapulte del giocatore [{player2.Username}] hanno causato:");
                Send(clientGuid2, $"Log_Server|Frecce utilizzate: {arcieri_Enemy * Esercito.Unità.Arciere.Componente_Lancio + catapulte_Enemy * Esercito.Unità.Catapulta.Componente_Lancio}");
            ...
            if (arcieri_Enemy > 0 || catapulte_Enemy > 0)
            {
                ...
                Send(clientGuid, $"Log_Server|Frecce utilizzate: {arcieri * Esercito.Unità.Arciere.Componente_Lancio + catapulte * Esercito.Unità.Catapulta.Componente_Lancio}");
